...
int main(int argc, char* argv[]) {
  ...
  lrl2::LRL2SolverConfig solver_config;
  ...
  lrl2::LRL2Solver lrl2_solver(&table_group, &w_table, &w_snapshot_table,
  ...
  for (int i = 0; i < FLAGS_num_threads; ++i) {
    worker_threads.create_thread(
        boost::bind(&lrl2::LRL2Solver::Solve, boost::ref(lrl2_solver)));
  }
