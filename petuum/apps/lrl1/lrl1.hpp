...
class LRL1Solver {
  public:
    LRL1Solver(petuum::TableGroup<float> *table_group,
  ...
  private:
    ...
    int32_t SolveBatch(int32_t data_idx);
    int32_t SolveBatchPartialWeights(int32_t data_idx);
    ...
    boost::thread_specific_ptr<LRL1SolverThreadData> _solver_thread_data;
